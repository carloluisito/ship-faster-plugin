...
| [Gotchas](gotchas.md) | Something behaves in a way the code does not explain, or before touching the areas listed in covers. | Hook stdin hangs, Windows renames, BOM shebangs, long-history staleness, tag pushes, test state leaks, and eval sandbox traps, with evidence. |
